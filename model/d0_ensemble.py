"""poker44-aquila — D0Aquila: weighted 4-member rank-blend on three feature views.
...
Weighted 4-member rank-blend at 0.26/0.22/0.3/0.22: a 72-leaf benchmark-supervised stack (cv4) and a 3-seed depth-5 monotone XGBoost on the behavioral view, a 3-seed PCA-48 MLP (56, 28) committee on the union view, and a drift-robust subspace ensemble (n=11, feature-fraction 0.68) on the v2 view.
"""
import numpy as np

# per-variant blend weights chosen at spec time (walk-forward verified)
W = {"stack": 0.26, "mono": 0.22, "mlp": 0.3, "drse": 0.22}
